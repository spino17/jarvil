...
use jarvil_parser::scope::lookup::LookupResult;
use jarvil_parser::scope::mangled::MangledIdentifierName;
use jarvil_parser::scope::scope::ScopeIndex;
use jarvil_parser::scope::semantic_db::SemanticStateDatabase;
use jarvil_parser::scope::symbol::core::{ConcreteSymbolDataEntry, SymbolDataEntry, SymbolIndex};
use jarvil_parser::scope::symbol::variables::VariableData;
use jarvil_parser::scope::traits::AbstractSymbol;
use jarvil_parser::{
    ast::{
        ast::{
