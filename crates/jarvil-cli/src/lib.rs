//! `jarvil` -- Jarvil's build tool and package manager.
//!
...
//! | Command | Effect |
//! |---------|--------|
//! | `jarvil new <name>` | scaffolds a project directory containing a `main.jv` |
//! | `jarvil build` | compiles `main.jv` to Python beside it |
//! | `jarvil run` | builds, then executes the generated Python |
//!
