...
pub const DECLARE_KEYWORD: &str                         = "declare";
...
pub const UNCLOSED_BLOCK_COMMENT: &str                  = "<unclosed-block-comment>";
pub const UNCLOSED_STRING_LITERAL_SINGLE_QUOTE: &str    = "<unclosed-string-literal-single-quote>";
pub const UNCLOSED_STRING_LITERAL_DOUBLE_QUOTE: &str    = "<unclosed-string-literal-double-quote>";
...
pub const VAR_SUFFIX: &str                              = "var";
pub const FUNC_SUFFIX: &str                             = "func";
pub const TY_SUFFIX: &str                               = "ty";
