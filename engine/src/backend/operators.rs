...
pub fn eval_add(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
    impl_eval_arithmetic_op!(+, l_data, r_data, eval_obj_add, tracker);
}

pub fn eval_subtract(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
    impl_eval_arithmetic_op!(-, l_data, r_data, eval_obj_subtract, tracker);
}

pub fn eval_multiply(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
    impl_eval_arithmetic_op!(*, l_data, r_data, eval_obj_multiply, tracker);
}

pub fn eval_divide(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
    match l_data {
...
pub fn eval_double_equal(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
...
pub fn eval_not_equal(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
    Data::BOOL(!eval_double_equal(l_data, r_data, tracker).as_bool())
}

pub fn eval_greater(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
    impl_eval_comparison_op!(>, l_data, r_data, eval_obj_greater, tracker);
}

pub fn eval_greater_equal(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
    impl_eval_comparison_op!(>=, l_data, r_data, eval_obj_greater_equal, tracker);
}

pub fn eval_less(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
    impl_eval_comparison_op!(<, l_data, r_data, eval_obj_less, tracker);
}

pub fn eval_less_equal(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
    impl_eval_comparison_op!(<=, l_data, r_data, eval_obj_less_equal, tracker);
}

pub fn eval_and(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
    impl_eval_logical_op!(&&, l_data, r_data, eval_obj_and, tracker);
}

pub fn eval_or(l_data: Data, r_data: Data, tracker: &mut ObjectTracker) -> Data {
